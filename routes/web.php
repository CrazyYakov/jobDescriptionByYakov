...
Route::group(['prefix' => 'superAdmin', 'namespace'=>'superAdmin', 'middleware'=> ['auth', 'superAdmin']], function () {
    ...
    Route::post('/institutions/store', 'InstitutionsController@store')->name('superAdmin.institutions.store');
    ...
    Route::post('/users/store/', 'UserController@store')->name('superAdmin.users.store');
    
});

Route::group(['prefix' => 'moderator', 'namespace'=>'moderator', 'middleware' => ['auth', 'moderator']], function () {
    Route::view('/', 'moderator.site');
    ...
    Route::post('/typeReqs/store', 'typeReqController@store')->name('moderator.typeReqs.store');
    ...
    Route::post('/requirements/store', 'RequirementController@store')->name('moderator.requirements.store');
    ...
    Route::post('/jobs/store', 'JobsController@store')->name('moderator.jobs.store');
    ...
    Route::post('/StructUnit/store', 'StructUnitController@store')->name('moderator.StructUnit.store');
});
