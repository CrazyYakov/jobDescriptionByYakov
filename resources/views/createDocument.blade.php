                    ...
                    {{csrf_field()}}               
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <textarea class="form-control update-field" name="RightAuto" id="" cols="30" rows="10">—Действовать от имени Университета по вопросам деятельности подразделения, представлять интересы подразделения во взаимоотношениях со структурными подразделениями Университета, а также органами государственной власти и местного самоуправления, иными лицами, учреждениями и организациями независимо от организационно-правовой формы и форм собственности по направлению деятельности в рамках делегированных полномочий, закрепленных организационно-распорядительных документах и (или) доверенностях.
