                    ...
                    {{csrf_field()}}               
                        <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                    <div class="card-body">
                                        ...
                                        <div class="required_education">
                                                ...
                                                <input type="text" class="form-control" name="experience" placeholder="стаж (далее вписать в род. падеже год/месяц)">
                                        </div>
                                        <br/>
                                        <div class="immediate_supervisor">
                            ...
                            @foreach ($typeReqs as $typeR)
                                ...
                                <div class="card">
                                        <div class="card-header" id="headingFour">
                                            <button class="btn btn-link collapsed" type="button" name="type{{$typeR->name}}" data-toggle="collapse" data-target="#type{{$typeR->id}}" aria-expanded="false" aria-controls="headingFour">
                                            <h2 class="mb-0">
                                                {{$typeR->nameType}}
                                            </h2>
                                            </button>
                                ...
                                @foreach ($requirements as $requirement)   
                                    ...
                                    <div class="card">
                                            <div class="card-header" id="headingFour">                                             
                                            <h2 class="mb-0">
                                            <button class="btn btn-link collapsed" name="requirement{{$requirement->id}}" type="button" data-toggle="collapse" data-target="#req{{$requirement->id}}" aria-expanded="false" aria-controls="headingFour">
                                                    {{$requirement->name}}
                                                </button>
                                            </h2>
                                            </div>
